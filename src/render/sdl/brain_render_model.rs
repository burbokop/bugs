...
pub struct SdlBrainRenderModel {}

impl Default for SdlBrainRenderModel {
    fn default() -> Self {
        Self {}
    }
}

impl BrainRenderModel for SdlBrainRenderModel {
    fn render(
        &self,
        ...
        let buffer_size = (buffer.width(), buffer.height());
        assert_eq!(
            buffer.as_bytes().len(),
